...
| `matchAll(rules, s)` | — |
| `analyze(card)` | — |
| `categories(card)` | Rôles d'une carte. Le type donne le cadre ; tout le reste vient de l'analyse : ce que chaque capacité produit, sur qui, ce que les coûts consomment et ce qui la déclenche. |
...
Marché Cardmarket, estimations & panier d'achat. *5 fonctions, 69 lignes, 2.5 Ko.*
...
Menue monnaie de l'atelier. *6 fonctions, 68 lignes, 2.2 Ko.*
