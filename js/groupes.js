/* =====================================================================
   ...
   les recommandations d'EDHREC — rangeaient chacune à sa façon, sans que rien
   ne se règle. Ce fichier leur donne un vocabulaire commun : une table de
   regroupements, une table de tris, et de quoi les appliquer à n'importe
   quelle liste d'entrées.

   Une « entrée » est ce que les sections manipulent déjà : un objet portant
   `.card`, et selon la section `.qty`, `.score` ou `.edhrec`. Rien d'autre
   n'est supposé.
   ===================================================================== */
...
/* ---------------------------------------------------------------------
   ...
   elle-même, relevé par la notation du deck (`NOTES_DECK`, js/deckSection.js), ou
